...
public class FileGBKToUTF {
   /* public static void main(String[] args) throws IOException {
        ...
        // 递归功能实现
        FileGBKToUTF fileGBKToUTF=new FileGBKToUTF();
        fileGBKToUTF.getAllJavaFilePaths(srcFolder);
    }*/

    public static void getAllJavaFilePaths(File srcFolder) throws IOException {
